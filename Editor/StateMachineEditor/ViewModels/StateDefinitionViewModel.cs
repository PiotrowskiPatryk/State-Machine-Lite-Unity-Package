...
namespace Dev.Cortez.StateMachines.Editor.StateMachineEditor.ViewModels
{
    public sealed class StateDefinitionViewModel : ViewModelBase
    {
        ...
        public StateDefinitionViewModel(string stateMachineType)
        {
            ...
            var definitionWrapper = ScriptableObject.CreateInstance<StateDefinitionEditorWrapper>();
            SerializedProperty =
                new SerializedObject(definitionWrapper).FindProperty(StateDefinitionEditorWrapper.DATA_PROPERTY_NAME);
