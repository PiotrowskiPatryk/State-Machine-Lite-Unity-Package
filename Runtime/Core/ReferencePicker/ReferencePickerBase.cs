...
namespace Dev.Cortez.StateMachines.Core.ReferencePicker
{
    ...
    {
        public const string SELECTED_STATE_MACHINE_CONTAINER_GUID_PROPERTY_NAME =
            nameof(_selectedStateMachineContainerGuid);

        public const string SELECTED_ITEM_ID_PROPERTY_NAME = nameof(_selectedItemId);
    ...
    public abstract class ReferencePickerBase<TItem> : ReferencePickerBase where TItem : class
    {
        ...
        public async UniTask<TItem> ResolveReferenceAsync(CancellationToken cancellationToken)
        {
            ...
            Observe(null, null, cancellationToken);
        ...
        protected abstract void DoSubscribe(StateMachineContainerRegistry stateMachineContainerRegistry,
            IdentifiableObserver<TItem> observer);

        protected abstract void DoUnsubscribe(StateMachineContainerRegistry stateMachineContainerRegistry,
            IdentifiableObserver<TItem> observer);
    }
}